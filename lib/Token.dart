...
""";
  ...
  Future<void> getCouponFeed() async {
    final String url = "https://inrdeals.com/api/v1";
    final Map<String, String> queryParams = {
      'store_id': '65',
      'token':'025f168d5ffe7444325576143c5848ec5ae5430c',
      'id':'esa574569153',
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> responseData = json.decode(response.body);
        print('Coupon feed: $responseData');
      } else {
        print('Failed to get coupon feed: ${response.statusCode}');
      }
    } catch (e) {
      print('Error fetching coupon feed: $e');
    }
  }

  Future<void> getTransactionReports() async {
    final String url = "https://inrdeals.com/fetch/reports";
    final Map<String, String> queryParams = {
      'token': '7b6c096bff4e51277d44c2cb89eb3040b5df837d',
      'id': 'esa574569153',
      'startdate': '2024-05-30',  // Correct parameter name: startdate
      'enddate': '2024-06-30'     // Correct parameter name: enddate
    };
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Map<String, dynamic> responseData = json.decode(response.body);
        print('Transaction reports: $responseData');
      } else {
        print('Failed to get transaction reports: ${response.statusCode}');
      }
    } catch (e) {
      print('Error fetching transaction reports: $e');
    }
  }
